...
const char* FileName = "/home/Desktop/voice/bin/wav";
const char* PlayPath = "play /home/Desktop/voice/bin/wav";
...
{
    int         ret                  = MSP_SUCCESS;
    const char* login_params         = "appid = 58977326, work_dir = .";//登录参数,appid与msc库绑定,请勿随意改动
    /*
    * rdn:           合成音频数字发音方式
    * volume:        合成音频的音量
    * pitch:         合成音频的音调
...
//    const char* text                 = "我是小丸子，今年126岁了，我的车牌号是12365，今年是2016年12月20号"; //合成文本
